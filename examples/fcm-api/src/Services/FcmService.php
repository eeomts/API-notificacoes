<?php
/**
 * Servico de envio de notificacoes via FCM V1
 */
class FcmService
{
    private $authService;
    ...
    /**
     * Envia notificacao para um unico dispositivo (token)
     *
     * @param string $token   FCM device token
     * @param string $title   Titulo da notificacao
     * @param string $body    Corpo da notificacao
     * @param array  $data    Dados extras (payload customizado)
     * @param array  $extras  Opcoes extras: android, apns, webpush
     * @return array
     */
    ...
    /**
     * Envia notificacao para um topico (topic)
     *
     * @param string $topic   Nome do topico (sem /topics/ prefix)
     * @param string $title
     * @param string $body
     * @param array  $data
     * @return array
    ...
    /**
     * Envia para multiplos tokens (multicast simulado - FCM V1 nao tem multicast nativo)
    ...
    /**
     * Executa o envio HTTP para a API FCM V1
     */
